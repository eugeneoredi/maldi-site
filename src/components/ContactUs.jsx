                ...
                >
                  ...
                  {d.href ? (
                    <a
                      ...
                      className="font-display font-medium text-sand-3 text-lg md:text-xl hover:text-rust transition-colors break-words"
                    >
                      {d.value}
                    </a>
                  ) : (
                    <p className="font-display font-medium text-sand-3 text-lg md:text-xl">{d.value}</p>
                  )}
                </div>
              ))}
            </div>
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="font-display font-medium w-full bg-transparent border-b-2 border-ink/15 py-2 text-ink text-lg focus:outline-none focus:border-lagoon-deep transition-colors"
                  />
                </div>
                <div>
                  <label
              ...
              <div>
                ...
                <input
                  ...
                  className="font-display font-medium w-full bg-transparent border-b-2 border-ink/15 py-2 text-ink text-lg placeholder:text-ink/40 focus:outline-none focus:border-lagoon-deep transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="font-display font-medium w-full bg-transparent border-b-2 border-ink/15 py-2 text-ink text-lg placeholder:text-ink/40 focus:outline-none focus:border-lagoon-deep transition-colors resize-none"
                />
              </div>
