        ...
        <div className="grid lg:grid-cols-3 gap-10 mt-14">
            ...
            <div className="space-y-6">
              {dining.map((d) => (
                <div key={d.title} className="border-l-2 border-rust pl-5">
                  ...
                  <p className="text-ink/82 text-base leading-relaxed">{d.text}</p>
                </div>
              ))}
            </div>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            ...
            <ul className="space-y-3">
              {heritage.map((h) => (
                <li key={h} className="flex gap-3 text-ink/85 text-base leading-relaxed">
            ...
            <div className="space-y-5">
              {photoSpots.map((p) => (
                <div key={p.title} className="group">
                  ...
                  <p className="text-ink/82 text-base leading-relaxed mt-1">{p.text}</p>
